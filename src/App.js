                    ...
                    <div style={AppStyles.CenterDiv}>
                        <form onSubmit={PushToDataBase} style={AppStyles.FormStyles}>
                            ...
                            <input onChange={e => setBookDesc(e.target.value)} style={AppStyles.FormInput}
                                   placeholder={'Enter here: '} type={'text'}/>
                            <label style={AppStyles.FormLabel}>Book Gener: </label>
                            <input style={AppStyles.FormInput} placeholder={"Enter here: "} onChange={e => setAuthorName(e.target.value)}/>
                            <label style={AppStyles.FormLabel}>Publication Year: </label>
                            <input style={AppStyles.FormInput} className={'margin-block'} onChange={(e) => setPublicationDate(e.target.value)} type={'date'} />
